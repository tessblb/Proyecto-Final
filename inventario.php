            ...
            <tbody>
                <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                    <tr>
                        ...
                        <td>
                            <a href="modiproducto.php?id=<?php echo $row['id_producto']; ?>" class="btn btn-warning">Modify</a>
                            <a href="deleteprodu.php?id=<?php echo $row['id_producto']; ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this product?');">Delete</a>
                        </td>                
                    </tr>
                <?php } ?>
            </tbody>
